        ...
        <div className={`${styles.grid} reveal`}>
          <form className={styles.form}>
            ...
            <div className={styles.field}>
              ...
              <textarea id="message" name="message" rows="4" placeholder="Volumes, sizes, colors, delivery timeline." />
            </div>
            <button className={styles.submit} type="button">Send Inquiry</button>
          </form>
